...
| `https://cantabile.tplinkdns.com:3358/nps/intraday.json` | **연기금 장중 매매(잠정)** — 1분 갱신 누적 순매수 시계열. 별도 채널(pi-worker 수집·서빙, CORS *). `date`가 오늘(KST)이 아니면 휴장/수집중단으로 간주할 것. 잠정치라 장 마감 확정치와 다름 |
